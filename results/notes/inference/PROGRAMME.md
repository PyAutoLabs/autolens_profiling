...
| W5 | Phase 8B log-coordinate stepping (Scaler → bijector) — **DISPATCHED (340576, 35/39 arms lost), rerun 341845/341860/341874/341875; 7 arms finished, 6 crashed at results-write (PyAutoFit#1535) and recovered offline from `search_internal.dill` 2026-08-27. F5 clean, F4 amended, NO verdict** | #162 | source + A100 | — (parallel smoothing arc) |
