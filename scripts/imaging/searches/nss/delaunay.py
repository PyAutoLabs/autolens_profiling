"""First-class af.NSS search profiling — imaging Delaunay.

Drives a full ``af.NSS`` (mainline blackjax.nss nested slice sampling) fit on an MGE lens + Hilbert image-mesh Delaunay
