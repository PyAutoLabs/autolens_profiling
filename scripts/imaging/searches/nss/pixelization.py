"""First-class af.NSS search profiling — imaging pixelization.

Drives a full ``af.NSS`` (mainline blackjax.nss nested slice sampling) fit on an MGE lens + RectangularAdaptImage
