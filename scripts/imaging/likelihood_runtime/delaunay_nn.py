...
# number. Pinned 2026-09-05 from that script's first eager CPU run on
# PyAutoLens v2026.8.17.1.
EXPECTED_LOG_EVIDENCE = {
    "hst": 29144.581943885652  # 1500-pixel Hilbert/DelaunayNN, MGE-60 lens, adapt_image=lensed_source
}
