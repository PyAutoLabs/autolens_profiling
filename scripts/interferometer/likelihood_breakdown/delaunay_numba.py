...
STEP_ACCESSORS = [
    ...
    ("Inversion build (trace+Delaunay+mapper)", _build_inversion),
    ...
    (
        "Regularization matrix H (ConstantSplit)",
...
print("\n" + "=" * 78)
print(
    f"NUMBA CPU DELAUNAY INTERFEROMETER PER-STEP BREAKDOWN — {instrument.upper()} — v{al_version}"
)
print("=" * 78)
...
fig.suptitle(
    f"Numba CPU Delaunay Interferometer Likelihood — Per-Step Breakdown — {instrument.upper()}",
    fontsize=12,
    fontweight="bold",
)
ax.set_title(
