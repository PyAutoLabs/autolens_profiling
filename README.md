...
| `imaging/delaunay` | hst | hpc_a100_fp64 | dense (mapping) | 117.4 ms | v2026.8.17.1 |
...
| `imaging/delaunay_nn` | hst | hpc_a100_fp64 | dense (mapping) | 256.4 ms | v2026.8.17.1 |
...
| `interferometer/delaunay_numba` | sma | local_cpu_fp64 | sparse (numba) | 515.1 ms | v2026.8.17.1 |
| `interferometer/pixelization_numba` | sma | local_cpu_fp64 | sparse (numba) | 451.1 ms | v2026.8.17.1 |
