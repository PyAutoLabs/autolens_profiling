...
| `imaging/delaunay` | hst | dense (mapping) | 10.07 s | v2026.7.6.649 |
| `imaging/delaunay` | hst | sparse (w-tilde) | 8.81 s | v2026.7.6.649 |
| `imaging/mge` | hst | dense (mapping) | 179.5 ms | v2026.7.6.649 |
| `imaging/pixelization` | hst | dense (mapping) | 8.65 s | v2026.7.6.649 |
| `imaging/pixelization` | hst | sparse (w-tilde) | 10.17 s | v2026.7.6.649 |
