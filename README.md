...
| `imaging/delaunay_numba` | hst | local_cpu_fp64 | sparse (numba) | 540.3 ms | v2026.8.17.1 |
...
| `imaging/pixelization_numba` | euclid | local_cpu_fp64 | sparse (numba) | 165.2 ms | v2026.8.17.1 |
| `imaging/pixelization_numba` | hst | local_cpu_fp64 | sparse (numba) | 386.9 ms | v2026.8.17.1 |
