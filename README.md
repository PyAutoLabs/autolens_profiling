...
| `interferometer/mge` | alma | local_cpu_fp64 | sparse (w-tilde) | 2.40 s | v2026.8.17.1 |
| `interferometer/mge` | alma | hpc_a100_fp64 | dense (mapping) | 943.2 ms | v2026.8.17.1 |
| `interferometer/mge` | alma | hpc_a100_fp64 | sparse (w-tilde) | 8.9 ms | v2026.8.17.1 |
...
| `interferometer/mge` | jvla | hpc_a100_fp64 | sparse (w-tilde) | 92.3 ms | v2026.8.17.1 |
...
| `interferometer/mge` | sma | local_cpu_fp64 | sparse (w-tilde) | 12.5 ms | v2026.8.17.1 |
