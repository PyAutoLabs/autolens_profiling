...
| `imaging/delaunay_numba` | hst | local_cpu_fp64 | sparse (numba) | 734.4 ms | v2026.8.17.1 |
...
| `imaging/pixelization_numba` | euclid | local_cpu_fp64 | sparse (numba) | 209.5 ms | v2026.8.17.1 |
| `imaging/pixelization_numba` | hst | local_cpu_fp64 | sparse (numba) | 633.4 ms | v2026.8.17.1 |
