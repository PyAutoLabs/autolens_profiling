...
| `imaging/delaunay_numba` | hst | local_cpu_fp64 | sparse (numba) | 679.2 ms | v2026.8.17.1 |
...
| `imaging/pixelization_numba` | euclid | local_cpu_fp64 | sparse (numba) | 288.6 ms | v2026.8.17.1 |
| `imaging/pixelization_numba` | hst | local_cpu_fp64 | sparse (numba) | 691.5 ms | v2026.8.17.1 |
