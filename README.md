...
| `imaging/delaunay_numba` | hst | local_cpu_fp64 | sparse (numba) | 3.22 s | v2026.8.17.1 |
...
| `imaging/pixelization_numba` | euclid | local_cpu_fp64 | sparse (numba) | 2.10 s | v2026.8.17.1 |
| `imaging/pixelization_numba` | hst | local_cpu_fp64 | sparse (numba) | 21.57 s | v2026.8.17.1 |
