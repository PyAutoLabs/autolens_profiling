...
| `imaging/delaunay` | hst | dense (mapping) | 28.28 s | v2026.7.6.649 |
| `imaging/delaunay` | hst | sparse (w-tilde) | 33.39 s | v2026.7.6.649 |
| `imaging/mge` | hst | dense (mapping) | 946.2 ms | v2026.7.6.649 |
| `imaging/pixelization` | hst | dense (mapping) | 28.08 s | v2026.7.6.649 |
| `imaging/pixelization` | hst | sparse (w-tilde) | 26.01 s | v2026.7.6.649 |
